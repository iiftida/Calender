...
import java.util.*
import com.simplemobiletools.calendar.pro.BuildConfig as BuildConfig1
...
class MainActivity : SimpleActivity(), RefreshRecyclerViewListener {
    ...
    private fun launchAbout() {
        ...
        startAboutActivity(R.string.app_name, licenses, BuildConfig1.VERSION_NAME, faqItems, true)
    }
    ...
    private fun checkWhatsNewDialog() {
        arrayListOf<Release>().apply {
            ...
            checkWhatsNew(this, BuildConfig1.VERSION_CODE)
        }
    }
}
